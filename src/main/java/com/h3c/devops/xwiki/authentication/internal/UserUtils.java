...
public class UserUtils
{
     ...
     * @param devopsUserAttribute the attributes from CAS.
     * @param context the XWiki context.
     * @throws XWikiException error when updating or creating XWiki user.
     */
    public static void syncUser(XWikiDocument userProfile, Map<String, Object> devopsUserAttribute, XWikiContext context)
            ...
            if (userProfile.isNew()) {
                ...
                if (devopsUserAttribute != null) {
                    for (Map.Entry<String, String> entry : userMappings.entrySet()) {
                        Object value = devopsUserAttribute.get(entry.getKey());
